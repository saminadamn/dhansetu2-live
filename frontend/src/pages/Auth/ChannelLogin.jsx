      ...
      <div className="bg-govBlue rounded-2xl shadow-xl border border-blue-900/40 w-full max-w-md overflow-hidden">
        ...
        <div className="p-8">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-white">{t("auth.channel.title")}</h2>
            <p className="text-blue-100 text-sm mt-1">
              {t("auth.channel.subtitle")}
            </p>
          </div>
          ...
          >
            <div className="space-y-1">
              <label className="text-xs font-semibold text-blue-100 uppercase tracking-wider">
                {t("auth.channel.idLabel")}
              </label>
              <input
                className={inputClass}
                placeholder={t("auth.channel.idPlaceholder")}
                value={employeeId}
            ...
            >
              {loading ? t("auth.loggingIn") : t("auth.channel.submit")}
            </button>
          </form>
